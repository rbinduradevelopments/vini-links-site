    ...
    <div className="page">
      <section className="hero">
        <div className="hero-left">
          <img className="hero-img" src="/vini-hero-bw.jpg" alt="Vincent J. Rigney" />
        </div>
        ...
        <div className="hero-right">
          ...
          <div className="hero-cta">
            <Link className="btn btn-primary" to="/music">Listen to Music</Link>
            <Link className="btn btn-secondary" to="/links">All Links</Link>
          </div>
        </div>
      </section>
      ...
      <section className="bio">
        <div className="bio-left">
          ...
          <p>
            Vincent J. Rigney is currently working on his third EP:
            <strong> “Rocky Road”</strong> for 2025.
          </p>
        </div>

        <div className="bio-right">
          <img className="bio-img" src="/vini-bio-colour.jpg" alt="Vincent J. Rigney with guitar" />
        </div>
      </section>
    </div>
  );
